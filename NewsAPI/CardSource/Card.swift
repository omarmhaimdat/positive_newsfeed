...
@objc public protocol CardDelegate {
    ...
    @objc optional func cardPostDidTapButton(card: CardHighlight, button: UIButton)
    @objc optional func cardPostLikeDidTapButton(card: CardHighlight, button: UIButton)
